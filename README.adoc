...
[source]
----
./mvnw compile com.google.cloud.tools:jib-maven-plugin:3.3.1:build -Dimage=<docker_id>/java-app:jib
----
...
[source]
----
./mvnw compile com.google.cloud.tools:jib-maven-plugin:3.3.1:buildTar -Dimage=java-app:jib
----
